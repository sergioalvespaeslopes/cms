...
<div class="container mx-auto p-6 bg-white shadow-lg rounded-lg max-w-lg">
    ...
    <form action="<?= base_url('/clients/update/' . $client['id']); ?>" method="POST" id="editClientForm">
        ...
        <input type="text" name="cep" id="cep" value="<?= esc($client['cep']); ?>" required class="w-full p-3 border border-gray-300 rounded-lg mb-4 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" title="CEP no formato XXXXX-XXX">
